...
export function TutorSidebar() {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border-r border-slate-200 dark:border-slate-700">
      {/* Logo/Brand section */}
      <div className="flex items-center px-6 py-6 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 shadow-lg">
        ...
        <div className="ml-3">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">Tutor Portal</p>
        </div>
      </div>
